...
internal val kanskje = Spesifikasjon<Søknad>(
...
internal val harOppfyltOpptjeningstid = (harVærtIArbeidIMinstFireUker eller kanskje).med(
...
internal val harOppfyltMedlemskap = (boddeINorgeISykdomsperioden eller kanskje).med(
...
internal val harIngenYtelserSomIkkeKanKombineresMedSykepenger = ikke(harAndreYtelser).eller(kanskje).med(
...
internal val erKravetFremsattInnenFrist = (erSendtInnenTreMåneder eller kanskje).med(
